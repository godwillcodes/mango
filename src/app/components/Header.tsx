    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-6 md:gap-12">
          ...
          <Link 
            href="/" 
            className="text-xl font-nexa-heavy tracking-tight text-white hover:opacity-90 transition-opacity focus-visible:outline-white focus-visible:outline-offset-4 focus-visible:outline-2 focus-visible:rounded-sm"
