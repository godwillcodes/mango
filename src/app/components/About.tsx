...
export default function AboutGuavaCreative() {
  ...
  return (
    <div className="relative bg-white overflow-hidden px-6 py-24 lg:px-8">
      <BackgroundPattern />
        ...
        >
          ...
          <div className="flex flex-col justify-center">
            ...
            <motion.h1 
              ...
              className="mt-3  font-bold tracking-tight text-gray-900 text-4xl"
            >
            ...
            >
              <motion.a
                href="/work"
                className="group inline-flex items-center px-6 py-3 bg-[#DB3246] text-white font-medium rounded-md overflow-hidden relative"
          ...
          >
            ...
            >
              ...
              >
                ...
                {/* Accent lines */}
                <motion.div 
                  className="absolute top-0 left-0 w-full h-1 bg-[#DB3246] opacity-70"
                  initial={{ width: 0 }}
                  animate={{ width: '100%' }}
                  transition={{ duration: 1, delay: 1.2 }}
                />
                <motion.div 
                  className="absolute bottom-0 right-0 w-full h-1 bg-[#DB3246] opacity-70"
                  initial={{ width: 0 }}
                  animate={{ width: '100%' }}
      ...
      <motion.div
  variants={itemVariants}
  className="mt-24 bg-[#DB3246] max-w-7xl mx-auto rounded-xl p-8 sm:p-12 shadow-md"
>
  <h2 className="text-center text-3xl font-bold text-white mb-8">What Sets Us Apart</h2>
  <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
    <div className="flex flex-col items-center">
      <div className="p-3 bg-[#DB3246]/10 rounded-full">
